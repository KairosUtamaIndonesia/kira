...
export function AppSocketProvider({ children }: { children: ReactNode }) {
  const wsRef = useRef<WebSocket | undefined>(undefined); // eslint-disable-line unicorn/no-useless-undefined
  ...
  const contextValue = useMemo(
    () => ({ send, connected, fatalError, onEvent }),
    [send, connected, fatalError, onEvent],
  );
