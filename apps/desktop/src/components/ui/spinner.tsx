...
const Default = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderIcon className={cn("animate-spin", className)} {...(props as LucideProps)} />
);

const Circle = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderCircleIcon className={cn("animate-spin", className)} {...(props as LucideProps)} />
);

const Pinwheel = ({ className, ...props }: SpinnerVariantProps) => (
  <LoaderPinwheelIcon className={cn("animate-spin", className)} {...(props as LucideProps)} />
);
...
export const Spinner = ({ variant, ...props }: SpinnerProps) => {
  switch (variant) {
    case "circle":
      return <Circle {...(props as LucideProps)} />;
    case "pinwheel":
      return <Pinwheel {...(props as LucideProps)} />;
    case "circle-filled":
      return <CircleFilled {...(props as LucideProps)} />;
    case "ellipsis":
      return <Ellipsis {...(props as LucideProps)} />;
    case "ring":
      return <Ring {...(props as LucideProps)} />;
    case "bars":
      return <Bars {...(props as LucideProps)} />;
    case "infinite":
      return <Infinite {...(props as LucideProps)} />;
    default:
      return <Default {...(props as LucideProps)} />;
  }
};
