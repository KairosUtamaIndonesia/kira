...
const SKILL_TOOL_PARAMETERS = Type.Object(
  {
    ...
    content: Type.Optional(
      Type.String({
        description:
          "Raw markdown body for create/update/edit, or new section content for patch. For create/update/edit you can provide this or the structured fields below.",
      }),
    ),
    when_to_use: Type.Optional(
      Type.String({
        description:
          "Structured create/update/edit field. Explain when this skill should be used and where its boundaries are.",
      }),
    ),
    procedure_steps: Type.Optional(
      Type.Array(Type.String(), {
        description:
          "Structured create/update/edit field. Ordered concrete steps for the workflow.",
      }),
    ),
    pitfalls: Type.Optional(
      Type.Array(Type.String(), {
        description:
          "Structured create/update/edit field. Optional common mistakes, caveats, or failure modes to avoid.",
      }),
    ),
    verification_steps: Type.Optional(
      Type.Array(Type.String(), {
        description:
          "Structured create/update/edit field. Concrete checks that confirm the workflow succeeded.",
      }),
    ),
  },
              ...
              content: [
                {
                  ...
                  text: JSON.stringify({
                    success: false,
                    error: "description is required for 'create' action.",
                  }),
                },
              ],
              details: {},
          ...
          if (!createBodyResult.body) {
            return {
              content: [
                {
                  type: "text",
                  text: JSON.stringify({ success: false, error: createBodyResult.error }),
                },
              ],
              details: {},
            };
          ...
          if (!doc) {
            return {
              content: [
                {
                  type: "text",
                  text: JSON.stringify({ success: false, error: `Skill '${skill_id}' not found.` }),
                },
              ],
              details: {},
            };
              ...
              content: [
                {
                  ...
                  text: JSON.stringify({
                    success: false,
                    error: "skill_id is required for 'patch' action.",
                  }),
                },
              ],
              details: {},
              ...
              content: [
                {
                  ...
                  text: JSON.stringify({
                    success: false,
                    error: "section is required for 'patch' action.",
                  }),
                },
              ],
              details: {},
          ...
          if (hasStructuredBody && !updateBodyResult.body) {
            return {
              content: [
                {
                  type: "text",
                  text: JSON.stringify({ success: false, error: updateBodyResult.error }),
                },
              ],
              details: {},
            };
              ...
              content: [
                {
                  ...
                  text: JSON.stringify({
                    success: false,
                    error: "skill_id is required for 'delete' action.",
                  }),
                },
              ],
              details: {},
