/**
 * Inline content of using-agent-skills, baked directly into the system prompt
 * (always present) instead of living as an on-demand skill.
 */
const usingAgentSkillsPrompt = `# Using Agent Skills
