...
/**
 * kira theme — built by `bunx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { kiraTheme } from './kira';
 *   import './kira.css';
 */
export const kiraTheme = {
  name: 'kira',
  __built: true,
  tokens: {
    ...
    "--font-family-heading": "\"Satoshi Variable\", \"Inter Variable\", system-ui, sans-serif",
    "--font-family-code": "\"Geist Mono Variable\", ui-monospace, monospace",
    ...
    "--color-background-surface": "light-dark(#FFFBFB, #231919)",
    "--color-background-body": "light-dark(#FCEEED, #190E0E)",
    "--color-background-card": "light-dark(#FFFBFB, #231919)",
    "--color-background-popover": "light-dark(#FFFBFB, #382E2E)",
    "--color-background-muted": "light-dark(#2319190D, #23191980)",
    "--color-accent": "light-dark(#C80033, #FFB2B2)",
    ...
    "--color-neutral": "light-dark(#2319191A, #EDDFDF33)",
    "--color-overlay": "light-dark(#23191966, #23191999)",
    "--color-overlay-hover": "light-dark(#2319190D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#2319191A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#231919, #EDDFDF)",
    "--color-text-secondary": "light-dark(#544342, #BBA6A6)",
    "--color-text-disabled": "light-dark(#A08C8C, #6C5A5A)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "light-dark(#FFFFFF, #7D000F)",
    ...
    "--color-icon-primary": "light-dark(#231919, #EDDFDF)",
    "--color-icon-secondary": "light-dark(#544342, #BBA6A6)",
    "--color-icon-disabled": "light-dark(#A08C8C, #6C5A5A)",
    ...
    "--color-border": "light-dark(#2319191A, #FCEEED1A)",
    "--color-border-emphasized": "light-dark(#A08C8C, #766463)",
    "--color-skeleton": "light-dark(#BBA6A6, #544342)",
    ...
    "--color-background-inverted": "light-dark(#231919, #FFFBFB)",
    "--color-track": "light-dark(#BBA6A6, #544342)",
    "--radius-chat": "0px"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","kira"],
  components: {
    "heading": {
      "level:1": {
